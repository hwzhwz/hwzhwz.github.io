...
var _typeof = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function (e) {
    ...
    }, precacheConfig = [["/index.html","be26ab0f43785883530de65ba626ac6a"]], cacheName = 'sw-precache-v3--' + (self.registration ? self.registration.scope : ''), firstRegister = 1, ignoreUrlParametersMatching = [/^utm_/], addDirectoryIndex = function (e, t) {
        e = new URL(e);
...
self.addEventListener('install', function (e) {
    ...
    return function r(o, i, s) {
        ...
        1: [function(e,t,n){function a(e,t){((t=t||{}).debug||c.debug)&&console.log("[sw-toolbox] "+e)}function i(e){var t=(t=e&&e.cache?e.cache.name:t)||c.cache.name;return caches.open(t)}function r(e){var t=Array.isArray(e);if(t&&e.forEach(function(e){"string"==typeof e||e instanceof Request||(t=!1)}),t)return e;throw new TypeError("The precache method expects either an array of strings and/or Requests or a Promise that resolves to an array of strings and/or Requests.")}var s,c=e("./options"),u=e("./idb-cache-expiration");t.exports={debug:a,fetchAndCache:function(r,o){var t=(o=o||{}).successResponses||c.successResponses;return fetch(r.clone()).then(function(e){return"GET"===r.method&&t.test(e.status)&&i(o).then(function(n){n.put(r,e).then(function(){var e,t=o.cache||c.cache;(t.maxEntries||t.maxAgeSeconds)&&t.name&&(e=function(e,t,n){var r=e.url,o=n.maxAgeSeconds,i=n.maxEntries,e=n.name,s=Date.now();return a("Updating LRU order for "+r+". Max entries is "+i+", max age is "+o),u.getDb(e).then(function(e){return u.setTimestampForUrl(e,r,s)}).then(function(e){return u.expireEntries(e,i,o,s)}).then(function(e){a("Successfully updated IDB.");e=e.map(function(e){return t.delete(e)});return Promise.all(e).then(function(){a("Done with cache cleanup.")})}).catch(function(e){a(e)})}.bind(null,e=r,n,t),s=s?s.then(e):e())})}),e.clone()})},openCache:i,renameCache:function(t,e,n){return a("Renaming cache: ["+t+"] to ["+e+"]",n),caches.delete(e).then(function(){return Promise.all([caches.open(t),caches.open(e)]).then(function(e){var n=e[0],r=e[1];return n.keys().then(function(e){return Promise.all(e.map(function(t){return n.match(t).then(function(e){return r.put(t,e)})}))}).then(function(){return caches.delete(t)})})})},cache:function(t,e){return i(e).then(function(e){return e.add(t)})},uncache:function(t,e){return i(e).then(function(e){return e.delete(t)})},precache:function(e){e instanceof Promise||r(e),c.preCacheItems=c.preCacheItems.concat(e)},validatePrecacheInput:r,isResponseFresh:function(e,t,n){if(!e)return!1;if(t){e=e.headers.get("date");if(e)if(new Date(e).getTime()+1e3*t<n)return!1}return!0}}},{"./idb-cache-expiration":2,"./options":4}],
        2: [function(e,t,n){var o="sw-toolbox-",i=1,u="store",h="url",f="timestamp",s={};t.exports={getDb:function(e){return e in s||(s[e]=(r=e,new Promise(function(e,t){var n=indexedDB.open(o+r,i);n.onupgradeneeded=function(){n.result.createObjectStore(u,{keyPath:h}).createIndex(f,f,{unique:!1})},n.onsuccess=function(){e(n.result)},n.onerror=function(){t(n.error)}}))),s[e];var r},setTimestampForUrl:function(r,o,i){return new Promise(function(e,t){var n=r.transaction(u,"readwrite");n.objectStore(u).put({url:o,timestamp:i}),n.oncomplete=function(){e(r)},n.onabort=function(){t(n.error)}})},expireEntries:function(e,n,t,r){return s=e,c=r,((a=t)?new Promise(function(e,t){var n=1e3*a,r=[],o=s.transaction(u,"readwrite"),i=o.objectStore(u);i.index(f).openCursor().onsuccess=function(e){var t,e=e.target.result;e&&c-n>e.value[f]&&(t=e.value[h],r.push(t),i.delete(t),e.continue())},o.oncomplete=function(){e(r)},o.onabort=t}):Promise.resolve([])).then(function(t){return a=e,((c=n)?new Promise(function(e,t){var r=[],n=a.transaction(u,"readwrite"),o=n.objectStore(u),i=o.index(f),s=i.count();i.count().onsuccess=function(){var n=s.result;c<n&&(i.openCursor().onsuccess=function(e){var t,e=e.target.result;e&&(t=e.value[h],r.push(t),o.delete(t),n-r.length>c&&e.continue())})},n.oncomplete=function(){e(r)},n.onabort=t}):Promise.resolve([])).then(function(e){return t.concat(e)});var a,c});var s,a,c}}},{}],
        ...
        6: [function(e,t,n){function i(e,t){for(var n=e.entries(),r=n.next(),o=[];!r.done;)new RegExp(r.value[0]).test(t)&&o.push(r.value[1]),r=n.next();return o}function o(){this.routes=new Map,this.routes.set(RegExp,new Map),this.default=null}var s=e("./route"),a=e("./helpers");["get","post","put","delete","head","any"].forEach(function(r){o.prototype[r]=function(e,t,n){return this.add(r,e,t,n)}}),o.prototype.add=function(e,t,n,r){r=r||{},o=t instanceof RegExp?RegExp:(o=r.origin||self.location.origin)instanceof RegExp?o.source:o.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&"),e=e.toLowerCase();var n=new s(e,t,n,r),r=(this.routes.has(o)||this.routes.set(o,new Map),this.routes.get(o)),o=(r.has(e)||r.set(e,new Map),r.get(e)),r=n.regexp||n.fullUrlRegExp;o.has(r.source)&&a.debug('"'+t+'" resolves to same regex as existing route.'),o.set(r.source,n)},o.prototype.matchMethod=function(e,t){var n=new URL(t),r=n.origin,n=n.pathname;return this._match(e,i(this.routes,r),n)||this._match(e,[this.routes.get(RegExp)],t)},o.prototype._match=function(e,t,n){if(0===t.length)return null;for(var r=0;r<t.length;r++){var o=t[r],o=o&&o.get(e.toLowerCase());if(o){o=i(o,n);if(0<o.length)return o[0].makeHandler(n)}}return null},o.prototype.match=function(e){return this.matchMethod(e.method,e.url)||this.matchMethod("any",e.url)},t.exports=new o},{"./helpers":1,"./route":5}],
        ...
        9: [function(e,t,n){var u=e("../helpers"),h=e("./cacheOnly");t.exports=function(s,a,c){return u.debug("Strategy: fastest ["+s.url+"]",c),new Promise(function(t,n){function e(e){e instanceof Response?t(e):i("No result returned")}var r=!1,o=[],i=function(e){o.push(e.toString()),r?n(new Error('Both cache and network failed: "'+o.join('", "')+'"')):r=!0};u.fetchAndCache(s.clone(),c).then(e,i),h(s,a,c).then(e,i)})}},{"../helpers":1,"./cacheOnly":8}],
        ...
        11: [function(e,t,n){var u=e("../options"),h=e("../helpers");t.exports=function(i,e,s){var a=(s=s||{}).successResponses||u.successResponses,c=s.networkTimeoutSeconds||u.networkTimeoutSeconds;return h.debug("Strategy: network first ["+i.url+"]",s),h.openCache(s).then(function(e){var t,n,r=[],o=(c&&(o=new Promise(function(r){t=setTimeout(function(){e.match(i).then(function(e){var t=s.cache||u.cache,n=Date.now(),t=t.maxAgeSeconds;h.isResponseFresh(e,t,n)&&r(e)})},1e3*c)}),r.push(o)),h.fetchAndCache(i,s).then(function(e){if(t&&clearTimeout(t),a.test(e.status))return e;throw h.debug("Response was an HTTP error: "+e.statusText,s),n=e,new Error("Bad response")}).catch(function(t){return h.debug("Network or response error, fallback to cache ["+i.url+"]",s),e.match(i).then(function(e){if(e)return e;if(n)return n;throw t})}));return r.push(o),Promise.race(r)})}},{"../helpers":1,"../options":4}],
        ...
        15: [function(e,t,n){function l(e,t){for(var n=[],r=0,o=0,i="",s=t&&t.delimiter||"/";null!=(f=x.exec(e));){var a,c,u,h,f,l=f[0],p=f[1],d=f.index;i+=e.slice(o,d),o=d+l.length,p?i+=p[1]:(d=e[o],l=f[2],p=f[3],a=f[4],c=f[5],u=f[6],h=f[7],i&&(n.push(i),i=""),f=f[2]||s,n.push({name:p||r++,prefix:l||"",delimiter:f,optional:"?"===u||"*"===u,repeat:"+"===u||"*"===u,partial:null!=l&&null!=d&&d!==l,asterisk:!!h,pattern:(p=a||c)?p.replace(/([=!:$\/()])/g,"\\$1"):h?".*":"[^"+m(f)+"]+?"}))}return o<e.length&&(i+=e.substr(o)),i&&n.push(i),n}function p(e){return encodeURI(e).replace(/[\/?#]/g,function(e){return"%"+e.charCodeAt(0).toString(16).toUpperCase()})}function r(h){for(var f=new Array(h.length),e=0;e<h.length;e++)"object"==_typeof(h[e])&&(f[e]=new RegExp("^(?:"+h[e].pattern+")$"));return function(e,t){for(var n="",r=e||{},o=(t||{}).pretty?p:encodeURIComponent,i=0;i<h.length;i++){var s=h[i];if("string"!=typeof s){var a,c=r[s.name];if(null==c){if(s.optional){s.partial&&(n+=s.prefix);continue}throw new TypeError('Expected "'+s.name+'" to be defined')}if(y(c)){if(!s.repeat)throw new TypeError('Expected "'+s.name+'" to not repeat, but received `'+JSON.stringify(c)+"`");if(0===c.length){if(s.optional)continue;throw new TypeError('Expected "'+s.name+'" to not be empty')}for(var u=0;u<c.length;u++){if(a=o(c[u]),!f[i].test(a))throw new TypeError('Expected all "'+s.name+'" to match "'+s.pattern+'", but received `'+JSON.stringify(a)+"`");n+=(0===u?s.prefix:s.delimiter)+a}}else{if(a=s.asterisk?encodeURI(c).replace(/[?#]/g,function(e){return"%"+e.charCodeAt(0).toString(16).toUpperCase()}):o(c),!f[i].test(a))throw new TypeError('Expected "'+s.name+'" to match "'+s.pattern+'", but received "'+a+'"');n+=s.prefix+a}}else n+=s}return n}}function m(e){return e.replace(/([.+*?=^!:${}()[\]|\/\\])/g,"\\$1")}function d(e,t){return e.keys=t,e}function g(e){return e.sensitive?"":"i"}function v(e,t,n){y(t)||(n=t||n,t=[]);for(var r=(n=n||{}).strict,o=!1!==n.end,i="",s=0;s<e.length;s++){var a,c,u=e[s];"string"==typeof u?i+=m(u):(a=m(u.prefix),c="(?:"+u.pattern+")",t.push(u),u.repeat&&(c+="(?:"+a+c+")*"),i+=c=u.optional?u.partial?a+"("+c+")?":"(?:"+a+"("+c+"))?":a+"("+c+")")}var h=m(n.delimiter||"/"),f=i.slice(-h.length)===h;return r||(i=(f?i.slice(0,-h.length):i)+"(?:"+h+"(?=$))?"),i+=o?"$":r&&f?"":"(?="+h+"|$)",d(new RegExp("^"+i,g(n)),t)}function w(e,t,n){if(y(t)||(n=t||n,t=[]),n=n||{},e instanceof RegExp){var r=e,o=t,i=r.source.match(/\((?!\?)/g);if(i)for(var s=0;s<i.length;s++)o.push({name:s,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,asterisk:!1,pattern:null});return d(r,o)}if(y(e)){for(var a=e,c=t,u=n,h=[],f=0;f<a.length;f++)h.push(w(a[f],c,u).source);return d(new RegExp("(?:"+h.join("|")+")",g(u)),c)}return r=t,v(l(e,t=n),r,t)}var y=e("isarray"),x=(t.exports=w,t.exports.parse=l,t.exports.compile=function(e,t){return r(l(e,t))},t.exports.tokensToFunction=r,t.exports.tokensToRegExp=v,new RegExp(["(\\\\.)","([\\/.])?(?:(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?|(\\*))"].join("|"),"g"))},{isarray:14}],
